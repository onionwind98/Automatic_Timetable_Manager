...
class _OngoingTasksState extends State<OngoingTasks> {
  ...
  loadTask() async {
    ...
    api.postData('getOngoingTask', data).then((res) async {
      setState(() {
        ...
        for (int i = 0; i < ongoingTaskList.length; i++) {
          ...
          ongoingTaskList[i]['subtitle'] = DateFormat('E').format(date) +
              ' ' +
              date.day.toString() +
              '/' +
              date.month.toString() +
              '   ' +
              ongoingTaskList[i]['startTime'] +
              '-' +
              ongoingTaskList[i]['endTime'];
        }
  ...
  Widget displayDatePicker() {
    return AlertDialog(
      ...
      content: StatefulBuilder(
        ...
        return WeekPicker(
            ...
            setState(() {
              ...
              selectedDate['dateRange'] =
                  selectedDate['startDate'].year.toString() +
                      '\n' +
                      selectedDate['startDate'].day.toString() +
                      '/' +
                      selectedDate['startDate'].month.toString() +
                      ' - ' +
                      selectedDate['endDate'].day.toString() +
                      '/' +
                      selectedDate['endDate'].month.toString();
          ...
          datePickerStyles: DatePickerRangeStyles(
              ...
              dayHeaderStyle:
                  DayHeaderStyle(textStyle: TextStyle(color: Colors.white))),
      ...
      actions: [
        MaterialButton(
          child: button.myAlertActionButton(
              'Confirm', Colors.white, Colors.black, context),
          onPressed: () async {
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        onChanged: (String? value) {
                          setState(() {
                            sortOption = value!;
                            ongoingTaskList = sortFunction.sortFunction(
                                ongoingTaskList, sortOption);
                          });
                        },
                      ),
                    ),
              ...
              Container(
                decoration:
                    boxDeco.myBoxDecoration(Color.fromRGBO(127, 235, 249, 1)),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: SingleChildScrollView(
                        ...
                        itemCount: ongoingTaskList.isEmpty
                            ? 1
